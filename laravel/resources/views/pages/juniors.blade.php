<x-layout title="ناشئو الفريق | نادي بلاد الرافدين">
      ...
      <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
          ...
          <style>
            ...
            #section-juniors { padding-top: 8px; }
            #section-juniors .spacer-single { height: 10px !important; }
            ...
            <div class="container">
              ...
              <div class="toolbar" dir="rtl">
                <div class="toolbar-left">
                  <input id="searchInputJuniors" class="input" type="text" placeholder="ابحث بالاسم..." />
                  <select id="filterDisciplineJuniors" class="select">
                    <option value="">كل التخصصات</option>
                    <option value="كارتينغ">كارتينغ</option>
                    <option value="درفت">درفت</option>
                    <option value="تايم أتاك">تايم أتاك</option>
                  </select>
                </div>
                <div class="toolbar-right">
                  <button id="resetFiltersJuniors" class="btn-soft">إعادة تعيين</button>
                </div>
              </div>
              <div class="row">
                <div class="col-12 text-end">
                  <div class="section-title">قائمة الناشئين</div>
                </div>
              </div>
              <div class="row g-4">
                <div class="col-lg-4 col-md-4 mb-sm-30 junior-card" data-name="حسن أحمد" data-discipline="كارتينغ">
                ...
                <div class="col-lg-4 col-md-4 mb-sm-30 junior-card" data-name="عمر محمود" data-discipline="درفت">
                  <div class="de-team-list member-card">
                    <div class="de-team-item">
                      <div class="de-team-pic">
                ...
                <div class="col-lg-4 col-md-4 mb-sm-30 junior-card" data-name="كريم حسن" data-discipline="تايم أتاك">
                  <div class="de-team-list member-card">
                    <div class="de-team-item">
                      <div class="de-team-pic">
...
<script>
  (function(){
    const cards = Array.from(document.querySelectorAll('.junior-card'));
    const searchInput = document.getElementById('searchInputJuniors');
    const filterDiscipline = document.getElementById('filterDisciplineJuniors');
    const resetBtn = document.getElementById('resetFiltersJuniors');
    const statTotal = document.getElementById('statTotalJuniors');
